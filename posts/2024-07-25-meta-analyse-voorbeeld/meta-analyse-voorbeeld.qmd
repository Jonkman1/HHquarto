...
description: |
   Hoe voer je een meta-analyse uit met R, wat levert het op en maak je de tekst op in Tufte-stijl. Hier vind je een voorbeeld waarin de relatie tussen ingrijpende jeugdervaringen van ouders en de sensitiviteit naar hun kinderen toe wordt onderzocht en waarbij in de analyse enkele moderatoren worden meegenomen.
