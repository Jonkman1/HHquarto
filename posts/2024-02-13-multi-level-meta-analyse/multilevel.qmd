...
description: |
    Op dit moment begeleid ik een groep studenten bij het opstellen en afronden van hun masterthesis. Daarvoor moeten ze een meta-analyse uitvoeren. Mij is gevraagd toe te werken bijvoorbeeld naar een multilevel meta-analyse. Daarvoor heb ik het hoofdstuk *"Multilevel" meta-analyse* uit het boek *Doing Meta-Analysis in R* van Harrer, Cuijpers, Furukawa, and Ebert (2021) vertaald en bewerkt. De komende tijd zal ik het hele boek als een notitieboek opzetten. Dit hoofdstuk is een aanzet daarvoor. 
...
Op dit moment begeleid ik een groep studenten bij het opstellen en afronden van hun masterthesis. Daarvoor moeten ze een meta-analyse uitvoeren over de relatie tussen ingrijpende jeugdervaring (Adversed Childhood Experiences (ACE's)) en opvoeden. Mij is gevraagd toe te werken naar een multilevel meta-analyse, een methode waarbij rekening wordt gehouden met de afhankelijkheid van effect sizes (zie bv. Assink, Wibbelink, et al. 2016). Voor mijzelf was hierbij het hoofdstuk *"Multilevel" meta-analyse* uit het boek *Doing Meta-Analysis in R* van Harrer, Cuijpers, Furukawa, and Ebert (2021) zeer inzichtelijk. Omdat het zo behulpzaam was heb ik het vertaald en bewerkt. De komende tijd zal ik het hele boek van Harrer et al. als een notitieboek opzetten. Dit hoofdstuk is een aanzet daarvoor met een of twee maanden zal het als blog hierverschijnen. Elk hoofdstuk wordt dan, net als dit hoofdstuk, verdeeld in enkele theoretische notities en een praktisch deel waarin getoond wordt hoe het werkt in `R`.
...
![Drie niveaustructuur](Screenshot2.png)
...
## Materialen
- [Hier](https://bookdown.org/MathiasHarrer/Doing_Meta_Analysis_in_R/) vind je het boek van Harrer en anderen.
- [Hier](https://www.researchgate.net/publication/307168012_Fitting_three-level_meta-analytic_models_in_R_A_step-by-step_tutorial) vind je het artikel van Assink en Wibbelink.
- [Hier](https://pure.uva.nl/ws/files/2679897/166572_Handleiding_drie_level_meta_analyse_in_R_versie_3.2_.pdf) vind je de handleiding bij dat artikel.
